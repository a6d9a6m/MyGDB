...
用法：
    python .codex/hooks/check_quality.py knowledge/articles/github-20260317-001.json
    python .codex/hooks/check_quality.py knowledge/articles/*.json
...
def main() -> int:
    ...
    raw_args = sys.argv[1:]
    if not raw_args:
        print("[SKIP] 未发现需要评估的 knowledge/articles/*.json 文件")
        return 0
